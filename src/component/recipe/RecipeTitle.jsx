  ...
  return (
    <div className=" max-w-[1600px] mx-auto py-10 grid  justify-center mt-[50px]  items-center font-Lexend">
      ...
      <div className=" w-[90%] lg:w-[60%] mx-auto text-center space-y-4">
        ...
        <p className=" text-[16px] text-[#150B2B99 ]">Welcome to our recipe section, where culinary inspiration meets mouthwatering delight! Discover a world of flavors, techniques, and culinary creativity right at your fingertips. </p>
      </div>
      </div>
    </div>
  );
